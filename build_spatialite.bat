...
call fetch.bat http://www.gaia-gis.it/gaia-sins/libspatialite-sources/libspatialite-4.3.0a.tar.gz libspatialite-4.3.0a
...
"%SEDC%" -i makefile.vc -e "s@iconv.lib@iconv.lib $(PREFIX)\\\\lib\\\\libcharset.lib@g"
